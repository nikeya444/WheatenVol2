                        ...
                        <form:form modelAttribute="searchCriteria" action="${action}" method="get">
                                ...
                                <div class="col-xs-10">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker1">
                                            <form:input path="documentCriteria.from" class="form-control" />
                                ...
                                <div class="col-xs-10">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker2">
                                            <form:input path="documentCriteria.to" type="text" cssClass="form-control" />
                                            <span class="input-group-addon">
                                              <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        <c:forEach items="${documentTypes}" var="documentType">
                                            <div class="checkbox">
                                            <label>
                                                <form:checkbox path="documentCriteria.documentTypes" value="${documentType.key}"/>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <form:checkbox path="documentCriteria.order" />Включая заказы
                                        </label>
                ...
                <c:forEach items="${documents}" var="document" varStatus="i">
                    <c:if test="${!date.equals(document.dateOfDocument)}">
                        ...
                        <div class="row">
                             <div class="col-lg-6">
                                 <div class="row">
                                    <div class="col-lg-3 center-block"><c:out value="${document.partner.fullname}"/></div>
                                 </div>
                             </div>
                             <div class="col-lg-4">
