        ...
        <form:form role="form" modelAttribute="document" id="documentForm">
            ...
            <div id="records">
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <span style="font-weight: bold;">Куда</span>
                    </div>
                    ...
                    <div class="row data" id="dataRow${i.index}">
                        <div class="col-xs-3">
                            ...
                            <form:errors path="details[${i.index}].product" cssClass="errors" />
                                ...
                                <div class="col-xs-2">
                                    <form:select path="details[${i.index}].source"  cssClass="form-control input-sm" id="storage">
                                        <option value="0">Склад</option>
                                        <form:options items="${storages}" itemValue="id" itemLabel="name" />
                                    </form:select>
                                    <form:errors path="details[${i.index}].source" cssClass="errors" />
                                </div>
                                <div class="col-xs-2">
                                    <form:select path="details[${i.index}].destination"  cssClass="form-control input-sm" id="storage1">
                                        <option value="0">Склад</option>
                                        <form:options items="${storages}" itemValue="id" itemLabel="name" />
                                    </form:select>
                                    <form:errors path="details[${i.index}].destination" cssClass="errors" />
                                </div>
